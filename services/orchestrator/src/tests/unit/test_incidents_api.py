...
def test_get_incident_success():
    ...
    with (
        ...
        create_response = client.post(
            "/api/v1/incidents", json={"description": "Test incident for GET pod:test-pod namespace:test-namespace"}
        )
        ...
        assert incident_data["description"] == "Test incident for GET pod:test-pod namespace:test-namespace"
