...
def test_create_incident_poll_status_get_completed_results():
...
def test_background_investigation_continues_after_cli_disconnect():
    ...
    with (
        ...
        # 2. Verify investigation started
        assert investigation_started, "Investigation should have started"

        # 3. Simulate CLI disconnect by not polling immediately
...
def test_timeout_handling_in_cli():
...
def test_failed_investigation_preserves_partial_results():
...
def test_multiple_concurrent_investigations():
