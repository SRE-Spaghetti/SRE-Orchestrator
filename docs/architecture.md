...
| :--- | :--- | :--- | :--- | :--- |
| **Language** | Python | 3.12.4 | Primary development language | Modern, robust, with excellent support for AI/ML and web frameworks. Specified in PRD. |
| **Framework (API)** | FastAPI | 0.111.0 | High-performance web framework for building REST APIs | Offers modern Python features, automatic docs, and dependency injection. Specified in PRD. |
| **Framework (Agent)**| LangGraph | 0.0.53 | Framework for building stateful, multi-actor agent applications | Provides a robust way to create and coordinate AI agents. Specified in PRD. |
| **Dependency Mgt** | Poetry | 1.8.2 | Dependency management and packaging | Simplifies dependency resolution and ensures reproducible builds. Specified in PRD. |
| **Containerization**| Docker | 26.1.3 | Container runtime and tooling | Standard for containerizing applications for consistent deployment. Specified in PRD. |
| **Orchestration** | Kubernetes | 1.30.2 | Container orchestration platform | Industry standard for deploying and managing containerized applications at scale. |
| **Deployment** | Helm | 3.15.1 | Package manager for Kubernetes | Simplifies the deployment and management of applications on Kubernetes. Specified in PRD. |
